...
class ProductDao {
    ...
    fun add(product: Product) {
        Companion.product.add(product)
    }

    fun searchProduct(): List<Product> {
        return Companion.product.toList()
    }
    ...
    companion object {
        private val product = mutableListOf<Product>(
            Product(
                ...
                image = "https://matsudapet.com.br/blog/wp-content/uploads/2019/07/5-cuidados-que-voc%C3%AA-precisa-ter-com-a-ra%C3%A7%C3%A3o-para-gato.jpg"
            ),
            Product(
